...
[_unit] call compile preprocessFileLineNumbers 'equip_patterns\ru_msv\rpg7_ammo.sqf';
[_unit] call compile preprocessFileLineNumbers 'equip_patterns\ru_msv\assistant.sqf';
